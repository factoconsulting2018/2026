            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <button type="button" 
                                class="btn btn-info btn-lg zip-download-btn" 
                                onclick="downloadZip(<?= $model->id ?>)"
                                style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%); border: none; display: none;">
                            <span class="material-symbols-outlined" style="font-size: 18px; vertical-align: middle; margin-right: 4px;">public</span>
                            Descargar ZIP
                        </button>
...
.order2-view .btn:hover {
    transform: translateY(-2px);
    transition: all 0.3s ease;
}

.order2-view .detail-view th {
    background-color: #f8f9fa;
    font-weight: 600;
    color: #333;
}

.order2-view .detail-view td {
