...
$this->title = 'Actualizar Orden: ' . $model->rental_id;
...
<div class="order2-update">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" id="order-fecha_final" name="Order[fecha_final]" value="<?= Html::encode($model->fecha_final ?: '') ?>">
                    </div>
    ...
    <div class="form-group mt-4">
        <div class="d-flex gap-3">
            <?= Html::submitButton('<span class="material-symbols-outlined" style="font-size: 18px; vertical-align: middle; margin-right: 4px;">save</span>Actualizar Orden', [
